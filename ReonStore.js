...
const pler = JSON.parse(fs.readFileSync('./lib/idgrup.json').toString())
const contacts = JSON.parse(fs.readFileSync("./database/contacts.json"))

virgam = fs.readFileSync(`./image/rawr.jpeg`)
const totalFitur = () =>{
...
await ReonStore.sendMessage(from, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: "Nih Kak Tinggal Pencet File Di Atas Terus Save", mimetype: "text/vcard", }, { quoted: m })
...
await ReonStore.sendMessage(sender, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: "Sukses Tinggal Save Ya Kakak", mimetype: "text/vcard", }, { quoted: m })
contacts.splice(0, contacts.length)
fs.writeFileSync("./database/contacts.json", JSON.stringify(contacts))
}
}
